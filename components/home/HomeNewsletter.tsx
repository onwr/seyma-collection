...
export function HomeNewsletter() {
  return (
    <section className="mb-12 overflow-hidden rounded-3xl bg-[#ad516b] p-12 text-center text-white">
      ...
      <form className="mx-auto flex max-w-md gap-2" onSubmit={(e) => e.preventDefault()}>
        <input
          ...
          className="w-full rounded-full border-none bg-white px-6 py-3 text-zinc-900 focus:ring-2 focus:ring-[#ddb1bd]"
          required
        />
        <button
          type="submit"
