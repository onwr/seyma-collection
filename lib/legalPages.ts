...
Cayma hakkının kullanıldığına dair bildirimin, 14 (ondört) günlük süre içinde Satıcı'ya yazılı olarak, Satıcı'ya ait faks, telefon veya elektronik posta veya kalıcı veri saklayıcısı ile yapılması ve Ürünün 6. madde hükümleri çerçevesinde kullanılmamış olması gerekir.
...
- Malın tesliminden sonra ambalajın açılmış olması halinde dijital içerik ve bilgisayar sarf malzemeleri
